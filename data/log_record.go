...
// 标记数据目前状态
const (
	LogRecordNormal  LogRecordType = iota // 正常状态的数据
	LogRecordDeleted                      // 删除状态的数据
)
...
// EncodeLogRecord 对LogRecord编码，返回字节数组及长度
